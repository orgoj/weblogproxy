...
- Improved config validation: domain name, add_log_data fields, script_injection URLs (now allows relative paths, e.g. /scripts/base-tracking.js), and rule headers are now strictly validated with clear error messages
